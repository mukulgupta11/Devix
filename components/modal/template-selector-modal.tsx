        ...
        {step === "select" ? (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-blue-500 shadow-[0_0_0_1px_#3b82f6,0_8px_20px_rgba(59,130,246,0.15)]"
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#3b82f6,0_8px_20px_rgba(59,130,246,0.15)] rounded-lg border">
