...
const CodeSuggestionCard: React.FC<{
  ...
  return (
    <div className="border border-zinc-700/50 rounded-lg overflow-hidden bg-muted/30 my-3 group hover:bg-zinc-900/50 transition-colors">
      ...
      <>
        ...
        >
            ...
            <div className="p-6 space-y-6">
                    ...
                    <div
                      className={cn(
                        ...
                        msg.role === "user"
                          ...
                          : "bg-card/80 backdrop-blur-sm text-foreground p-5 rounded-bl-md border border-border/50"
                      )}
                    >
                      {msg.role === "assistant" && (
              ...
              {isLoading && (
                <div className="flex items-start gap-4 justify-start">
                  ...
                  <div className="bg-card/80 backdrop-blur-sm border border-border/50 p-5 rounded-xl rounded-bl-md flex items-center gap-3">
          ...
          {attachments.length > 0 && (
            <div className="shrink-0 border-t border-border bg-zinc-900/50 p-4">
            ...
            <div className="flex items-end gap-3">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  disabled={isLoading}
                  className="min-h-[44px] max-h-32 bg-muted/50 border-border text-foreground placeholder-zinc-500 focus:border-blue-500 focus:ring-blue-500/20 resize-none pr-20"
                  rows={1}
                />
